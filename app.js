...
// 👉 Wird beim Deploy aus dem GitHub-Secret SHEETS_URL ersetzt.
//    Steht der Platzhalter noch drin (lokal), laeuft die Seite im Demo-Modus.
const RAW_WEB_APP_URL = "__SHEETS_URL__";

const CONFIG = {
  WEB_APP_URL: RAW_WEB_APP_URL.slice(0, 2) === "__" ? "" : RAW_WEB_APP_URL,
